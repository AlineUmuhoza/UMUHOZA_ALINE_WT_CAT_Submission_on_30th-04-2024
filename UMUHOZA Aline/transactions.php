...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $connection->prepare("INSERT INTO transactions(TransactionID,AccountID, TransactionType, Amount, TransactionDate) VALUES (?, ?, ?, ?, ?)");
    $stmt->bind_param("sssss", $tid, $aid, $trtyp, $mnt, $trdt);
        ...
        if ($result->num_rows > 0) {
            ...
            while ($row = $result->fetch_assoc()) {
                ...
                echo "<tr>
                    ...
                    <td><a style='padding:4px' href='delete_transactions.php?TransactionID=$tid'>Delete</a></td> 
                    <td><a style='padding:4px' href='update_transactions.php?TransactionID=$tid'>Update</a></td> 
                </tr>";
            }
        } else {
